class LabelsController < ApplicationController
  ...
  # GET /labels/new
  def new
    if @ticket = Ticket.find_by_id(new_label_params[:ticket_id])
      @label = Label.new(ticket: @ticket, customer: @ticket.customer)
    else
      @label = Label.new
    end
  ...
  private
    ...
    def label_params
      params.require(:label).permit(:ticket_id, :customer_id, :address)
    end
